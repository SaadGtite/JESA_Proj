...
const Section4 = () => {
  ...
  const [sectionTitle, setSectionTitle] = useState('Section 4: Final Evaluation');
  ...
  // --- Handlers (copy from Section3.js) ---
    ...
    <div className="crr-section">
      ...
      <div className="questions-section">
        {questions.length > 0 ? (
          ...
          <p style={{ color: 'red', fontWeight: 'bold' }}>⚠️ Aucune question trouvée pour la Section 4.</p>
        )}
      </div>
